...
using namespace std;
#define MAX 256
int count(int argc, char **argv, int digitCount[],
int letterCount[], int symbolCount[], int spaceCount[]);
int countInput(char input[], int digitCount[], int letterCount[],
...
int main(int argc, char **argv)
{
	...
	if (argc == 1)
	{
		...
		countInput(input, digitCount, letterCount, symbolCount, spaceCount);
	}
	else
	{
		count(argc, argv, digitCount, letterCount, symbolCount, spaceCount);
	}
